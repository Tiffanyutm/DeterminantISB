...
# subset data to only include demographic and geographic variables, perceptions, behaviours, recreational engagement
...
# Encode data function (source: R-bloggers Anindya Mozumdar )
...
pp_D2 <- ggplot(newdat_m1d2, aes(fill = Level, y = Probability, x = D2 )) +
  ...
  scale_fill_discrete_diverging("Green-Brown", labels = c("Never", "Rarely", "Sometimes", "Most of the Time", "Always"))
pp_D2 + theme(axis.text.x = element_text(angle = 45, hjust = 1))
...
pp_j <- ggplot(newdat_m1j, aes(fill = Level, y = Probability, x = JURISDICTION )) +
  ...
  scale_fill_discrete_diverging("Green-Brown", labels = c("Never", "Rarely", "Sometimes", "Most of the Time", "Always"))
pp_j + theme(axis.text.x = element_text(angle = 45, hjust = 1))
...
pp_b <- ggplot(newdat_m1b, aes(fill = Level, y = Probability, x = BASIN)) +
  ...
  scale_fill_discrete_diverging("Green-Brown", labels = c("Never", "Rarely", "Sometimes", "Most of the Time", "Always"))
pp_b + theme(axis.text.x = element_text(angle = 45, hjust = 1))
...
pp_q3m2 <- ggplot(newdat_q3m2, aes(fill = Level, y = Probability, x = Q3)) +
  ...
  scale_fill_discrete_diverging("Green-Brown", labels = c("Never", "Rarely", "Sometimes", "Most of the Time", "Always"))
pp_q3m2 + theme(axis.text.x = element_text(angle = 45, hjust = 1))



Save <- ggplot(newdat_m1d1, aes(x = D1, y = Probability, colour = Level, shape = Level)) +
  geom_point() +
  scale_shape_manual(labels = c("Never", "Rarely", "Sometimes", "Most of the Time", "Always"), values=c(3, 15, 16, 17, 18)) +
  scale_color_colorblind(labels = c("Never", "Rarely", "Sometimes", "Most of the Time", "Always")) +
  labs(
    x = "Age Range",
    y = "Predicted Probability",
    color = "Level",
