...
ggsave("pp_b.png", pp_b, dpi = 300)
ggsave("pp_bbm2.png", pp_bbm2, dpi = 300)
ggsave("pp_bm2.png", pp_bm2, dpi = 300)
ggsave("pp_D1.png", pp_D1, dpi = 300)
ggsave("pp_D2.png", pp_D2, dpi = 300)
ggsave("pp_j.png", pp_j, dpi = 300)
ggsave("pp_q3m2.png", pp_q3m2, dpi = 300)
